...
export default function Water() {
  return <InnerPage eyebrow="09 / ETERNAL PRAISE WATER" title="Pure. Refreshing." accent="Made for everyday life." intro="A polished water-brand experience built around product presentation, production, quality and dependable supply.">
