...
export default function Water() {
  return <InnerPage theme="water" eyebrow="09 / ETERNAL PRAISE WATER" title="Pure. Refreshing." accent="Made for everyday life." intro="A water brand experience built around freshness, clarity, quality and dependable supply.">
    <section className="water-landing-hero">
      ...
      <div className="water-landing-content"><span className="section-tag">ETERNAL PRAISE WATER</span><h2>Refreshment you can <span>see.</span></h2><p>Pure-looking, refreshing and presented with the confidence a bottled water brand deserves.</p><div className="water-landing-actions"><Link className="button water-button" to="/contact">Make an enquiry <ArrowRight size={17}/></Link><a className="water-scroll-link" href="#water-story">Explore the brand ↓</a></div></div>
      <div className="water-landing-badge"><Droplets size={24}/><span>PURE<br/><b>REFRESHING</b><br/>RELIABLE</span></div>
    </section>

    <section className="inner-section water-detail water-detail-hero" id="water-story"><div className="water-hero-visual"><img src="https://images.unsplash.com/photo-1564419320461-6870880221ad?auto=format&fit=crop&w=1400&q=88" alt="Bottled water product"/><div className="water-product-stamp"><Droplets size={18}/><span>ETERNAL PRAISE<br/>WATER</span></div></div><div><span className="section-tag">ETERNAL PRAISE / TABLE WATER</span><h2>Quality at the source.<br /><span>Confidence in every bottle.</span></h2><p className="lead">Eternal Praise Water is presented as a consumer product brand within the Segol group, with a clear path from production to customer.</p><p className="water-disclaimer">Product sizes, certifications, factory details, approved claims and distribution areas should be replaced with the client&apos;s verified information before launch.</p><Link className="button dark-button" to="/contact">Make an enquiry <ArrowRight size={17}/></Link></div></section>
