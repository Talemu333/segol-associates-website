...
const data = {
  project: { eyebrow: '03 / PROJECT MANAGEMENT', title: 'Make the project', accent: 'easier to control.', intro: 'Structured project management support that connects objectives, people, schedules, resources and delivery.', icon: Target, points: ['Project planning and work breakdown', 'Schedule coordination and progress tracking', 'Resource and stakeholder coordination', 'Risk, issue and delivery visibility'] },
  oil: { eyebrow: '04 / OIL FIELD PLANNING', title: 'Plan the field', accent: 'before execution.', intro: 'Planning and management support that helps oil field activities stay aligned around scope, resources, timing and execution.', icon: Factory, points: ['Activity and execution planning', 'Schedule and resource coordination', 'Operational communication and reporting', 'Progress and delivery support'] },
  construction: { eyebrow: '05 / CONSTRUCTION & ENGINEERING', title: 'From design intent', accent: 'to completed work.', intro: 'Construction delivery support built around coordination, practical planning and disciplined project management.', icon: HardHat, points: ['Design and scope coordination', 'Construction programme planning', 'Progress and stakeholder coordination', 'Handover and completion support'] },
}
